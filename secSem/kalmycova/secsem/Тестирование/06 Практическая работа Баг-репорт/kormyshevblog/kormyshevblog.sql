...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 13 2024 г., 06:10
...
(2, 'Это плохой комментарий', 1, 2, 1),
(3, 'что-то', 1, 1, 4),
(4, 'query', 0, 1, 1),
(5, 'Комент с сайта', 1, 1, 3),
(6, 'новый комент с сайта', 1, 1, 4),
(7, 'geuawgeugaugaurgaur', 1, 2, 4);
...
CREATE TABLE `posts` (
  ...
  `thumbnailUrl` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(3, 'Данил Админков', 'danadmin@mail.ru', 'admin123', 1);
