        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-4">
                ...
                <section class="border-bottom mb-4">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-lg-6 text-center text-lg-start mb-3 m-lg-0">
                            ...
                            <span> Опубликовано <u>15.07.2020</u> by</span>
                ...
                <section class="border-bottom mb-3">
                    <?php
                    $conn = new mysqli("localhost", "root", "", "kormyshevblog");
                    $get_comments_query = "SELECT * FROM `comments` WHERE isApproved = 1 AND post_id = " . $_GET['id'];
                ...
                <section>
                    ...
                    <?php if (isset($_SESSION['current_user_id'])) : ?>
                        <form action="../functions/doComment.php" method="post">

                            <!-- Message input -->
                            <div class="form-outline mb-4" data-mdb-input-init>
                                <textarea name="text" class="form-control" id="form4Example3" rows="4"></textarea>
